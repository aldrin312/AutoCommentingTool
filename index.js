...
export async function getGroqChatCompletion(data, api,groqInstance) {
    // Initialize the Groq API with the provided API key
    const groq = groqInstance || new Groq({ apiKey: api });
...
export async function writeIntoFile(data, fileName) {
